  ...
  def train(self):
    ...
    for epoch in xrange(int(F.epoch)):
      ...
      if epoch % F.validation_epochs ==0:
        ...
        val_image_pred = recompose2D_overlap(predictions_val, 128, 128, self.extraction_step[0],
        ...
        pred2d = np.reshape(val_image_pred, (val_image_pred.shape[0] * 128 * 128))
        lab2d = np.reshape(labels_val, (labels_val.shape[0] * 128 * 128))

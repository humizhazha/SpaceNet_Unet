...
# Define flags
flags = tf.app.flags
flags.DEFINE_integer("epoch", 1, "Number of training epochs (default: 100000)")
...
flags.DEFINE_integer("number_train_images", 200, "No. of images for training")
...
flags.DEFINE_integer("number_train_unlab_images", 200, "No. of unlabeled images for training")
flags.DEFINE_integer("validation_epochs", 10, "Do validation after every validation epochs")

# set the class type
flags.DEFINE_integer("type_number", 0, "No. of class type")
